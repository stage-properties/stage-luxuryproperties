...
const PropertyInfoServer = ({ offplanData, areaUnit, t, isRTL, direction }) => {
  ...
  return (
    <div
      className="propertyInfo gradientBorder"
      ...
      >
        ...
        <div className="contentContainer">
          <div className="wrapper">
            <h2 className={`mainHeading ${isRTL ? "ar" : ""}`}>
            ...
            <ul className="pInfo">
              <li className={`list ${isRTL ? "ar" : ""}`}>
                ...
                <div className="right">
                  <span className="value">
                    {
                      offplanData?.attributes?.community?.data?.attributes
                        ?.community_name
                    }
                    ,{" "}
                    {
                      offplanData?.attributes?.community?.data?.attributes
                        ?.emirate?.data?.attributes?.emirate_name
                    }
                    , {t("UAE")}
                  </span>
                </div>
              ...
              <li className={`list ${isRTL ? "ar" : ""}`}>
                ...
                <div className="right">
                  <Link
                    href={`/developers/${offplanData?.attributes?.developer?.data?.attributes?.slug}`}
                  >
              ...
              <li className={`list ${isRTL ? "ar" : ""}`}>
                ...
                <div className="right">
                  <span className="value">
                    {offplanData?.attributes?.project_status
                      ? offplanData?.attributes?.project_status
                      : t("Ask for status")}
                  </span>
                </div>
              ...
              <li className={`list ${isRTL ? "ar" : ""}`}>
                ...
                <div className="right">
                  <Link
                    href={`/areas-and-communities/${offplanData?.attributes?.community?.data?.attributes?.slug}`}
                  >
                    <span className="textUnderline">
                      {
                        offplanData?.attributes?.community?.data?.attributes
                      ...
                      {offplanData?.attributes?.property_types?.data?.map(
                        (item, index) =>
                          ...
                          offplanData?.attributes?.property_types?.data?.length
                            ? " and "
                            : index !==
                              offplanData?.attributes?.property_types?.data
                                ?.length -
                                1
                            ? ", "
                            : "")
            ...
            {offplanData?.floor_plan?.length > 0 ? (
              <FloorPlan
                ...
                floorPlan={offplanData?.floor_plan}
              />
            ) : null}
          </div>
        </div>
