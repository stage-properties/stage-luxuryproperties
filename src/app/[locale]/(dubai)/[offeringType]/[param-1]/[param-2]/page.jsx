...
export async function generateMetadata({ params }) {
  ...
  try {
    ...
    const contructTitle = () => {
      if(propertyType === 'properties-for-sale' || propertyType === 'properties-for-rent'){
    ...
    const constructDescription = () => {
      if(propertyType === 'properties-for-sale' || propertyType === 'properties-for-rent'){
        ...
        else return 'Explore available ' + param1 + " " + t_common(param2) + " in Dubai & Ras Al Khaimah with Stage Properties."
      } else return 'Explore available ' + param1 + " " + t_common(param2) + " in Dubai & Ras Al Khaimah with Stage Properties."
    }
