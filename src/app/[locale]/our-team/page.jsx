...
export async function generateMetadata({ params }) {
  ...
  const t_meet_our_team = await getTranslations({
    locale,
    namespace: "meet_our_team",
  });
    ...
    <>
      ...
      <div id="ourTeam" dir={direction}>
        ...
        <ListingContainer
          ...
          heading={t_meet_our_team("management")}
          type="MANAGEMENT"
          apiType="management"
          APIinfo={managementData?.meta}
        />
        <ListingContainer
          data={seniorAgentData?.data}
          heading={t_meet_our_team("Senior Property Consultants")}
          apiType="senior"
          type="AGENT"
          APIinfo={seniorAgentData?.meta}
        />
        <ListingContainer
          data={agentData?.data}
          heading={t_meet_our_team("Property Consultants")}
          type="AGENT"
          apiType="junior"
          APIinfo={agentData?.meta}
        />
