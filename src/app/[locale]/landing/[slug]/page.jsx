...
export async function generateMetadata({ params }) {
    ...
    const section_1_img_alt = data?.section_1_img?.data?.attributes?.alternativeText || title
...
export default async function page({ params }) {
    ...
    const title = data?.project_title;
    const developer_logo = data?.developer?.data?.attributes?.developer_logo?.data?.attributes?.url
    const developer_logo_alt = data?.developer?.data?.attributes?.developer_logo?.data?.attributes?.alternativeText || title;

    const project_logo_black = data?.project_logo_black?.data?.attributes?.url
    const project_logo_black_alt = data?.project_logo_black?.data?.attributes?.alternativeText
    ...
    const form_img_alt = data?.form_img?.data?.attributes?.alternativeText || title;
        ...
        <div className="landing">
            ...
            <div className="wrapper">
                <div className="content-container">
                    ...
                    <div className="location-container">
                        {time_to_almaktoumAirport ? (<div className="location-item">
                            <div className="location-time">
                                {time_to_almaktoumAirport} min{time_to_almaktoumAirport >= 2 ? 's' : ''}.
                            </div>
                        ...
                        {time_to_palmJumeirah ? (<div className="location-item">
                            <div className="location-time">
                                {time_to_palmJumeirah} min{time_to_palmJumeirah >= 2 ? 's' : ''}.
                            </div>
                            <div className="location-text">to Palm</div>
                            <div className="location-text">Jumeirah</div>
                        </div>): null}
                        {time_to_burjAlArab ? (<div className="location-item">
                            <div className="location-time">
                        ...
                        {time_to_theWalkJBR ? (<div className="location-item">
                            <div className="location-time">
                        ...
                        {time_to_dxdAirport ? (<div className="location-item">
                            <div className="location-time">
                                {time_to_dxdAirport} min{time_to_dxdAirport >= 2 ? 's' : ''}.
                            </div>
                            <div className="location-text">
                                to DXB International
                            </div>
                            <div className="location-text">Airport</div>
                        </div>) : null}
                        {time_to_BurjKhalifa ? (<div className="location-item">
                            <div className="location-time">
            ...
            <div className="wrapper">
                <div className="content-container">
                    ...
                    <div className="location-container">
                        {/* Barbecue area */}
                        {barbecue_area ? (<div className="location-item">
                            <div className="location-time">
                                <img src="/icons/barbecue_area.svg" alt="Barbecue Area" height={88} />
                            </div>
                            <div className="location-text" style={{marginTop: '.5rem'}}>Barbecue Area</div>
                        </div>) : null}
                        {/* Basketball court */}
                        {basketball_court ? (<div className="location-item">
                            <div className="location-time">
                                <img src="/icons/basketball_court.svg" alt="basketball Court" height={88} />
                            </div>
                            <div className="location-text" style={{marginTop: '.5rem'}}>Basketball Court</div>
                        </div>): null}
                        {/* Cinema */}
                        {cinema ? (<div className="location-item">
                            <div className="location-time">
                                <img src="/icons/cinema.svg" alt="Cinema" height={88} />
                            </div>
                            <div className="location-text" style={{marginTop: '.5rem'}}>Cinema</div>
                        </div>) : null}
                        {/* Cycling Trail */}
                        {cycling_trail ? (<div className="location-item">
                            <div className="location-time">
                                <img src="/icons/cycling_trail.svg" alt="Cycling Trail" height={88} />
                            </div>
                            <div className="location-text" style={{marginTop: '.5rem'}}>Cycling Trail</div>
                        </div>) : null}
                        {/* Green Spaces */}
                        {green_spaces ? (<div className="location-item">
                            <div className="location-time">
                                <img src="/icons/green_spaces.svg" alt="Green Spaces" height={88} />
                            </div>
                            <div className="location-text" style={{marginTop: '.5rem'}}>Green Spaces</div>
                        </div>) : null}
                        {/* Infinity Pool */}
                        {infinity_pool ? (<div className="location-item">
                            <div className="location-time">
                                <img src="/icons/infinity_pool.svg" alt="Infinity Pool" height={88} />
                            </div>
                            <div className="location-text" style={{marginTop: '.5rem'}}>Infinity Pool</div>
                        </div>) : null}
                        {/* Jogging Trail */}
                        {jogging_trail ? (<div className="location-item">
                            <div className="location-time">
                                <img src="/icons/jogging_trail.svg" alt="Jogging Trail" height={88} />
                            </div>
                            <div className="location-text" style={{marginTop: '.5rem'}}>Jogging Trail</div>
                        </div>) : null}
                        {/* Kids Play Area */}
                        {kids_play_area ? (<div className="location-item">
                            <div className="location-time">
                                <img src="/icons/kids_play_area.svg" alt="Kids Play Area" height={88} />
                            </div>
                            <div className="location-text" style={{marginTop: '.5rem'}}>Kids Play Area</div>
                        </div>) : null}
                        {/* Kids Pool */}
                        {kids_pool ? (<div className="location-item">
                            <div className="location-time">
                                <img src="/icons/kids_pool.svg" alt="Kids Pool" height={88} />
                            </div>
                            <div className="location-text" style={{marginTop: '.5rem'}}>Kids Pool</div>
                        </div>) : null}
                        {/* Parks */}
                        {parks ? (<div className="location-item">
                            <div className="location-time">
                                <img src="/icons/parks.svg" alt="Parks" height={88} />
                            </div>
                            <div className="location-text" style={{marginTop: '.5rem'}}>Parks</div>
                        </div>) : null}
                        {/* Retail */}
                        {retail ? (<div className="location-item">
                            <div className="location-time">
                                <img src="/icons/retail.svg" alt="Retail" height={88} />
                            </div>
                            <div className="location-text" style={{marginTop: '.5rem'}}>Retail</div>
                        </div>) : null}
                        {/* Rooftop Lounge */}
                        {rooftop_lounge ? (<div className="location-item">
                            <div className="location-time">
                                <img src="/icons/rooftop_lounge.svg" alt="Rooftop Lounge" height={88} />
                            </div>
                            <div className="location-text" style={{marginTop: '.5rem'}}>Rooftop Lounge</div>
                        </div>) : null}
                        {/* Tennis Court */}
                        {tennis_court ? (<div className="location-item">
                            <div className="location-time">
                                <img src="/icons/tennis_court.svg" alt="Tennis Court" height={88} />
                            </div>
                            <div className="location-text" style={{marginTop: '.5rem'}}>Tennis Court</div>
                        </div>) : null}
                        {/* Zen Garden */}
                        {zen_garden ? (<div className="location-item">
                            <div className="location-time">
                                <img src="/icons/zen_garden.svg" alt="Zen Garden" height={88} />
                            </div>
                            <div className="location-text" style={{marginTop: '.5rem'}}>Zen Garden</div>
                        </div>) : null}
                    </div>
                </div>
            </div>
            ...
            <div className="sticky-footer">
                ...
                <div>
                    {options.map(({option}, index) => <p key={index} className="sticky-footer-text">{option}</p>)}
                </div>
                <div>
                ...
                <div>
                    ...
                    <p className="sticky-footer-text">{currencyToSymbol(currency)} {convertPrice(starting_price)}</p>
                </div>
                <div>
                    <p className="sticky-footer-text">Handover</p>
                    <p className="sticky-footer-text">in {handover_year}</p>
                </div>
                <a className="register-button" href="#form-container">Register Interest</a>
            </div>
        </div>
    );
}