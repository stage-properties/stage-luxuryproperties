...
export async function GET() {
  try {
    ...
    const manualSkipUrls = [
      `${process.env.NEXT_PUBLIC_WEBSITE_URL}/areas-and-communities/maritime-city`,
      `${process.env.NEXT_PUBLIC_WEBSITE_URL}/areas-and-communities/jbr`,
      `${process.env.NEXT_PUBLIC_WEBSITE_URL}/areas-and-communities/dubai-investment-park`
    ];
    ...
    const entries = filteredData.reduce((acc, entry) => {
      ...
      const fullUrl = `${process.env.NEXT_PUBLIC_WEBSITE_URL}/${urlPath}`;
